...
//        }
//
//        Mek zhMek = (Mek) bheBinService.parse(zhFile.toString(), "GBK").getData();
//        Mek jaMek = (Mek) bheBinService.parse(jaFile.toString(), "windows-31j").getData();
//
//        TransferUtil.transJA2ZH(jaMek, zhMek);
//        bheBinService.generate(zhFile.toString(), jaMek, "GBK");
//
