...
/**
 * BHE -> BSDX 机体迁移入口。
 * 入口保持“旧参数”，内部转交给 Pipeline，避免外部调用方大面积改动。
...
public class TransMeka {
    ...
    public static TransMekaResult process(
            ...
            com.giga.nexas.dto.bhe.grp.groupmap.MekaGroupGrp.MekaGroup tsukuyomiMekaGroup,
            com.giga.nexas.dto.bhe.grp.groupmap.WazaGroupGrp.WazaGroupEntry tsukuyomiWazaGroup,
            com.giga.nexas.dto.bhe.grp.groupmap.SpriteGroupGrp.SpriteGroupEntry tsukuyomiSpriteGroup,
