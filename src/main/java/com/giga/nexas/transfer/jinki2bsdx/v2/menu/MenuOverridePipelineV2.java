 ...
 *
 * <p>它不参与 MEK/WAZ 主资源闭包推导，而是在主线已经把 AKAO 挂到目标 group 之后，
 ...
 */
public class MenuOverridePipelineV2 {

    /**
     * 菜单 DAT/SPM 生成时使用的字符集。
     *
     * <p>BSDX/JINKI 资源文本沿用 Windows 日文编码；这里必须和旧 pipeline 一致，
