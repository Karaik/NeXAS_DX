...
import com.giga.nexas.transfer.bhe2bsdx.meka.naoto.convert.BuildBaselineFromJinkiResultStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.naoto.convert.NaotoConvertOverviewStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.naoto.exe.PatchExeStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.naoto.graft.AppendGrpEntriesStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.naoto.graft.BuildResourceClosureStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.naoto.graft.ImportStaticAssetsStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.naoto.graft.PadBaselineMekMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.naoto.graft.RebindMekStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.naoto.graft.RebindWazStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.naoto.graft.SyncProgramMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.naoto.pack.PackUpdatePacStep;
...
public class NaotoGraftPipeline {
    ...
    private final NaotoConvertOverviewStep naotoConvertOverviewStep = new NaotoConvertOverviewStep();
    ...
    public NaotoGraftResult execute(NaotoGraftRequest request) {
        NaotoGraftResult result = new NaotoGraftResult();
        if (request == null) {
            return result;
        }
        ...
        TsukuyomiConvertedBundle convertedBundle = naotoConvertOverviewStep.convert(request, bsdxBaseline);
        ...
        TsukuyomiGrpAppendPlan grpAppendPlan = appendGrpEntriesStep.appendNaotoBranch(
                request,
                selectedPackage,
                bsdxBaseline,
                importPlan
        ...
        Mek reboundMek = rebindMekStep.rebindNaotoMek(
                request,
                selectedPackage,
                grpAppendPlan,
                convertedBundle.getCommonProjectileAppendPlan()
        );
        Waz reboundWaz = rebindWazStep.rebindNaotoWaz(
                request,
                selectedPackage,
                importPlan,
                grpAppendPlan,
    ...
    private void syncMainWazaSkillCountAfterInitializer(
        ...
        if (targetWazaIndex < 0 || targetWazaIndex >= bsdxBaseline.getWazaGroupGrp().getWazaList().size()) {
            throw new IllegalStateException("naoto initializer sync target index out of range: " + targetWazaIndex);
        }
