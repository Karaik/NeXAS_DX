...
import com.giga.nexas.transfer.bhe2bsdx.meka.misaki.convert.BuildBaselineFromJinkiResultStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.misaki.convert.MisakiConvertOverviewStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.misaki.exe.PatchExeStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.misaki.graft.AppendGrpEntriesStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.misaki.graft.BuildResourceClosureStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.misaki.graft.ImportStaticAssetsStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.misaki.graft.PadBaselineMekMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.misaki.graft.RebindMekStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.misaki.graft.RebindWazStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.misaki.graft.SyncProgramMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.misaki.pack.PackUpdatePacStep;
...
public class MisakiGraftPipeline {
    ...
    private final MisakiConvertOverviewStep misakiConvertOverviewStep = new MisakiConvertOverviewStep();
    ...
    public MisakiGraftResult execute(MisakiGraftRequest request) {
        MisakiGraftResult result = new MisakiGraftResult();
        if (request == null) {
            return result;
        }
        ...
        TsukuyomiConvertedBundle convertedBundle = misakiConvertOverviewStep.convert(request, bsdxBaseline);
        ...
        TsukuyomiGrpAppendPlan grpAppendPlan = appendGrpEntriesStep.appendMisakiBranch(
                request,
                selectedPackage,
                bsdxBaseline,
                importPlan
        ...
        Mek reboundMek = rebindMekStep.rebindMisakiMek(
                request,
                selectedPackage,
                grpAppendPlan,
                convertedBundle.getCommonProjectileAppendPlan()
        );
        Waz reboundWaz = rebindWazStep.rebindMisakiWaz(
                request,
                selectedPackage,
                importPlan,
                grpAppendPlan,
    ...
    private void syncMainWazaSkillCountAfterInitializer(
        ...
        if (targetWazaIndex < 0 || targetWazaIndex >= bsdxBaseline.getWazaGroupGrp().getWazaList().size()) {
            throw new IllegalStateException("misaki initializer sync target index out of range: " + targetWazaIndex);
        }
