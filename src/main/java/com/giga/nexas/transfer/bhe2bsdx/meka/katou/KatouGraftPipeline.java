...
import com.giga.nexas.transfer.bhe2bsdx.meka.katou.convert.BuildBaselineFromJinkiResultStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.katou.convert.KatouConvertOverviewStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.katou.exe.PatchExeStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.katou.graft.AppendGrpEntriesStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.katou.graft.BuildResourceClosureStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.katou.graft.ImportStaticAssetsStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.katou.graft.PadBaselineMekMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.katou.graft.RebindMekStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.katou.graft.RebindWazStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.katou.graft.SyncProgramMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.katou.pack.PackUpdatePacStep;
...
public class KatouGraftPipeline {
    ...
    private final KatouConvertOverviewStep katouConvertOverviewStep = new KatouConvertOverviewStep();
    ...
    public KatouGraftResult execute(KatouGraftRequest request) {
        KatouGraftResult result = new KatouGraftResult();
        if (request == null) {
            return result;
        }
        ...
        TsukuyomiConvertedBundle convertedBundle = katouConvertOverviewStep.convert(request, bsdxBaseline);
        ...
        TsukuyomiGrpAppendPlan grpAppendPlan = appendGrpEntriesStep.appendKatouBranch(
                request,
                selectedPackage,
                bsdxBaseline,
                importPlan
        ...
        Mek reboundMek = rebindMekStep.rebindKatouMek(
                request,
                selectedPackage,
                grpAppendPlan,
                convertedBundle.getCommonProjectileAppendPlan()
        );
        Waz reboundWaz = rebindWazStep.rebindKatouWaz(
                request,
                selectedPackage,
                importPlan,
                grpAppendPlan,
    ...
    private void syncMainWazaSkillCountAfterInitializer(
        ...
        if (targetWazaIndex < 0 || targetWazaIndex >= bsdxBaseline.getWazaGroupGrp().getWazaList().size()) {
            throw new IllegalStateException("katou initializer sync target index out of range: " + targetWazaIndex);
        }
