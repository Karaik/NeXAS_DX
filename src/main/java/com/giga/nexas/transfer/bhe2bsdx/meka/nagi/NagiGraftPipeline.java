...
import com.giga.nexas.transfer.bhe2bsdx.meka.nagi.convert.BuildBaselineFromJinkiResultStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.nagi.convert.NagiConvertOverviewStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.nagi.exe.PatchExeStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.nagi.graft.AppendGrpEntriesStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.nagi.graft.BuildResourceClosureStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.nagi.graft.ImportStaticAssetsStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.nagi.graft.PadBaselineMekMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.nagi.graft.RebindMekStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.nagi.graft.RebindWazStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.nagi.graft.SyncProgramMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.nagi.pack.PackUpdatePacStep;
...
public class NagiGraftPipeline {
    ...
    private final NagiConvertOverviewStep nagiConvertOverviewStep = new NagiConvertOverviewStep();
    ...
    public NagiGraftResult execute(NagiGraftRequest request) {
        NagiGraftResult result = new NagiGraftResult();
        if (request == null) {
            return result;
        }
        ...
        TsukuyomiConvertedBundle convertedBundle = nagiConvertOverviewStep.convert(request, bsdxBaseline);
        ...
        TsukuyomiGrpAppendPlan grpAppendPlan = appendGrpEntriesStep.appendNagiBranch(
                request,
                selectedPackage,
                bsdxBaseline,
                importPlan
        ...
        Mek reboundMek = rebindMekStep.rebindNagiMek(
                request,
                selectedPackage,
                grpAppendPlan,
                convertedBundle.getCommonProjectileAppendPlan()
        );
        Waz reboundWaz = rebindWazStep.rebindNagiWaz(
                request,
                selectedPackage,
                importPlan,
                grpAppendPlan,
    ...
    private void syncMainWazaSkillCountAfterInitializer(
        ...
        if (targetWazaIndex < 0 || targetWazaIndex >= bsdxBaseline.getWazaGroupGrp().getWazaList().size()) {
            throw new IllegalStateException("nagi initializer sync target index out of range: " + targetWazaIndex);
        }
