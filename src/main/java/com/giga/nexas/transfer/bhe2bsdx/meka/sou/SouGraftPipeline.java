...
import com.giga.nexas.transfer.bhe2bsdx.meka.sou.convert.BuildBaselineFromJinkiResultStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.sou.convert.SouConvertOverviewStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.sou.exe.PatchExeStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.sou.graft.AppendGrpEntriesStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.sou.graft.BuildResourceClosureStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.sou.graft.ImportStaticAssetsStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.sou.graft.PadBaselineMekMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.sou.graft.RebindMekStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.sou.graft.RebindWazStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.sou.graft.SyncProgramMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.sou.pack.PackUpdatePacStep;
...
public class SouGraftPipeline {
    ...
    private final SouConvertOverviewStep souConvertOverviewStep = new SouConvertOverviewStep();
    ...
    public SouGraftResult execute(SouGraftRequest request) {
        SouGraftResult result = new SouGraftResult();
        if (request == null) {
            return result;
        }
        ...
        TsukuyomiConvertedBundle convertedBundle = souConvertOverviewStep.convert(request, bsdxBaseline);
        ...
        TsukuyomiGrpAppendPlan grpAppendPlan = appendGrpEntriesStep.appendSouBranch(
                request,
                selectedPackage,
                bsdxBaseline,
                importPlan
        ...
        Mek reboundMek = rebindMekStep.rebindSouMek(
                request,
                selectedPackage,
                grpAppendPlan,
                convertedBundle.getCommonProjectileAppendPlan()
        );
        Waz reboundWaz = rebindWazStep.rebindSouWaz(
                request,
                selectedPackage,
                importPlan,
                grpAppendPlan,
    ...
    private void syncMainWazaSkillCountAfterInitializer(
        ...
        if (targetWazaIndex < 0 || targetWazaIndex >= bsdxBaseline.getWazaGroupGrp().getWazaList().size()) {
            throw new IllegalStateException("sou initializer sync target index out of range: " + targetWazaIndex);
        }
