...
import com.giga.nexas.transfer.bhe2bsdx.meka.wilhelm.convert.BuildBaselineFromJinkiResultStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.wilhelm.convert.WilhelmConvertOverviewStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.wilhelm.exe.PatchExeStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.wilhelm.graft.AppendGrpEntriesStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.wilhelm.graft.BuildResourceClosureStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.wilhelm.graft.ImportStaticAssetsStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.wilhelm.graft.PadBaselineMekMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.wilhelm.graft.RebindMekStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.wilhelm.graft.RebindWazStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.wilhelm.graft.SyncProgramMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.wilhelm.pack.PackUpdatePacStep;
...
public class WilhelmGraftPipeline {
    ...
    private final WilhelmConvertOverviewStep wilhelmConvertOverviewStep = new WilhelmConvertOverviewStep();
    ...
    public WilhelmGraftResult execute(WilhelmGraftRequest request) {
        WilhelmGraftResult result = new WilhelmGraftResult();
        if (request == null) {
            return result;
        }
        ...
        TsukuyomiConvertedBundle convertedBundle = wilhelmConvertOverviewStep.convert(request, bsdxBaseline);
        ...
        TsukuyomiGrpAppendPlan grpAppendPlan = appendGrpEntriesStep.appendWilhelmBranch(
                request,
                selectedPackage,
                bsdxBaseline,
                importPlan
        ...
        Mek reboundMek = rebindMekStep.rebindWilhelmMek(
                request,
                selectedPackage,
                grpAppendPlan,
                convertedBundle.getCommonProjectileAppendPlan()
        );
        Waz reboundWaz = rebindWazStep.rebindWilhelmWaz(
                request,
                selectedPackage,
                importPlan,
                grpAppendPlan,
    ...
    private void syncMainWazaSkillCountAfterInitializer(
        ...
        if (targetWazaIndex < 0 || targetWazaIndex >= bsdxBaseline.getWazaGroupGrp().getWazaList().size()) {
            throw new IllegalStateException("wilhelm initializer sync target index out of range: " + targetWazaIndex);
        }
