...
import com.giga.nexas.transfer.bhe2bsdx.meka.yuri.convert.BuildBaselineFromJinkiResultStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.yuri.convert.YuriConvertOverviewStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.yuri.exe.PatchExeStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.yuri.graft.AppendGrpEntriesStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.yuri.graft.BuildResourceClosureStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.yuri.graft.ImportStaticAssetsStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.yuri.graft.PadBaselineMekMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.yuri.graft.RebindMekStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.yuri.graft.RebindWazStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.yuri.graft.SyncProgramMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.yuri.pack.PackUpdatePacStep;
...
public class YuriGraftPipeline {
    ...
    private final YuriConvertOverviewStep yuriConvertOverviewStep = new YuriConvertOverviewStep();
    ...
    public YuriGraftResult execute(YuriGraftRequest request) {
        YuriGraftResult result = new YuriGraftResult();
        if (request == null) {
            return result;
        }
        ...
        TsukuyomiConvertedBundle convertedBundle = yuriConvertOverviewStep.convert(request, bsdxBaseline);
        ...
        TsukuyomiGrpAppendPlan grpAppendPlan = appendGrpEntriesStep.appendYuriBranch(
                request,
                selectedPackage,
                bsdxBaseline,
                importPlan
        ...
        Mek reboundMek = rebindMekStep.rebindYuriMek(
                request,
                selectedPackage,
                grpAppendPlan,
                convertedBundle.getCommonProjectileAppendPlan()
        );
        Waz reboundWaz = rebindWazStep.rebindYuriWaz(
                request,
                selectedPackage,
                importPlan,
                grpAppendPlan,
    ...
    private void syncMainWazaSkillCountAfterInitializer(
        ...
        if (targetWazaIndex < 0 || targetWazaIndex >= bsdxBaseline.getWazaGroupGrp().getWazaList().size()) {
            throw new IllegalStateException("yuri initializer sync target index out of range: " + targetWazaIndex);
        }
