...
import com.giga.nexas.transfer.bhe2bsdx.meka.freja.convert.BuildBaselineFromJinkiResultStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.freja.convert.FrejaConvertOverviewStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.freja.exe.PatchExeStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.freja.graft.AppendGrpEntriesStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.freja.graft.BuildResourceClosureStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.freja.graft.ImportStaticAssetsStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.freja.graft.PadBaselineMekMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.freja.graft.RebindMekStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.freja.graft.RebindWazStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.freja.graft.SyncProgramMaterialStep;
import com.giga.nexas.transfer.bhe2bsdx.meka.freja.pack.PackUpdatePacStep;
...
public class FrejaGraftPipeline {
    ...
    private final FrejaConvertOverviewStep frejaConvertOverviewStep = new FrejaConvertOverviewStep();
    ...
    public FrejaGraftResult execute(FrejaGraftRequest request) {
        FrejaGraftResult result = new FrejaGraftResult();
        if (request == null) {
            return result;
        }
        ...
        TsukuyomiConvertedBundle convertedBundle = frejaConvertOverviewStep.convert(request, bsdxBaseline);
        ...
        TsukuyomiGrpAppendPlan grpAppendPlan = appendGrpEntriesStep.appendFrejaBranch(
                request,
                selectedPackage,
                bsdxBaseline,
                importPlan
        ...
        Mek reboundMek = rebindMekStep.rebindFrejaMek(
                request,
                selectedPackage,
                grpAppendPlan,
                convertedBundle.getCommonProjectileAppendPlan()
        );
        Waz reboundWaz = rebindWazStep.rebindFrejaWaz(
                request,
                selectedPackage,
                importPlan,
                grpAppendPlan,
    ...
    private void syncMainWazaSkillCountAfterInitializer(
        ...
        if (targetWazaIndex < 0 || targetWazaIndex >= bsdxBaseline.getWazaGroupGrp().getWazaList().size()) {
            throw new IllegalStateException("freja initializer sync target index out of range: " + targetWazaIndex);
        }
