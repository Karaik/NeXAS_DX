...
public class CEventSpriteAttr extends SkillInfoObject {
    ...
    public static final CEventSpriteAttrType[] CEVENT_SPRITE_ATTR_TYPES = {
            ...
            new CEventSpriteAttrType(0xFFFFFFFF, "ビットン描画（未実装）"),
            new CEventSpriteAttrType(0xFFFFFFFF, "フィルム描画"),
            new CEventSpriteAttrType(0xFFFFFFFF, "モザイク描画（未実装）"),
            ...
            new CEventSpriteAttrType(0xFFFFFFFF, "ビットン色指定描画（未実装）"),
    ...
    public Integer fieldTableAddress = 0x00C36508;
    public Integer linkedDisplayTableAddress = 0x00B5EEF8;
    public Integer linkedDisplaySingleValueFlagAddress = 0x00B5EEFC;
    public Integer linkedDisplayTripleValueFlagAddress = 0x00B5EEFD;
