...
|-------------|-------|----------|-------|
| **BSDX** (Baldr Sky DiveX) | `.waz` `.mek` `.spm` `.grp` `.bin` `.dat` `.map` | Same | Most complete coverage |
| **BHE** (Baldr Heart EXE) | `.waz` `.mek` `.spm` `.grp` `.map` | `.spm` `.grp` `.map` | Used for comparison/transfer |
